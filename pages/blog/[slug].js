  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content={post?.summary || '트레이더 매매 시스템 블로그'} />
        <meta property="og:title" content={post ? `${post.title} - 매매 시스템` : '매매 시스템'} />
        <meta property="og:description" content={post?.summary || '트레이더 매매 시스템 블로그'} />
