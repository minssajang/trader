...
const PRACTICE_FEATURES = [
  {
    ...
    desc: '트레이딩뷰는 과거 날짜를 골라 재생하는 기능이 유료인데, 여기선 완전 무료예요. 이동평균선·볼린저밴드도 몇 개든 원하는 만큼 동시에 켜볼 수 있고(트레이딩뷰 무료판은 2~3개 제한), 스토캐스틱·MACD 같은 다른 보조지표가 필요하면 요청만 하면 추가해드려요. 골드·나스닥 데이터는 계속 늘어날 예정이라 앞으로 연습할 수 있는 날짜도 계속 많아져요.',
