...
export const BOLLINGER_BANDS = [
  ...
  { id: 'sma300', label: '15분 볼린저', period: 300, color: '#CDDC39' },
  { id: 'sma1200', label: '1시간 볼린저', period: 1200, color: '#2196F3' },
]
...
export const MOVING_AVERAGES = [
  ...
  { id: 'hma300', label: '15분 이평선', period: 300, color: '#CDDC39' },
  { id: 'hma1200', label: '1시간 이평선', period: 1200, color: '#2196F3' },
]
