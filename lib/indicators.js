...
// Madrid Moving Average Ribbon(EMA 5~90, 5씩) - MOVING_AVERAGES와 별도 묶음(사용자 요청).
// 1분봉 종가 기준 그대로(다른 이평선처럼 분 단위 치환 안 함). 원본 스크립트의 상태별 4색
// (라임/마룬/레드/그린) 동적 채색은 lightweight-charts가 선 하나 안에서 구간별 다른 색을
// 못 그려서(사용자 확인 후) 못 넣고, 대신 이평선처럼 18개 선을 각각 켜고 끄고 색상/굵기
// 커스터마이즈하는 고정색 그라데이션 리본으로 넣는다.
