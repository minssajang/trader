...
export const MOVING_AVERAGES = [
  { id: 'hma10', label: '30초 이평선', type: 'hma', period: 10, color: '#FFEB3B', lineWidth: 3, lineStyle: 2 },
  { id: 'hma20', label: '1분 이평선', type: 'hma', period: 20, color: '#F44336', lineWidth: 3, lineStyle: 2 },
  { id: 'hma60', label: '3분 이평선', type: 'hma', period: 60, color: '#4FC3F7', lineWidth: 3, lineStyle: 2 },
  { id: 'hma100', label: '5분 이평선', type: 'hma', period: 100, color: '#FF9800', lineWidth: 3, lineStyle: 2 },
  { id: 'hma300', label: '15분 이평선', type: 'hma', period: 300, color: '#6DFF38', lineWidth: 3, lineStyle: 2 },
  { id: 'hma1200', label: '1시간 이평선', type: 'hma', period: 1200, color: '#1F43F4', lineWidth: 3, lineStyle: 2 },
  // 여기부터 신규 추가분 (표시기간이 서로 달라서 라벨에 표시기간을 남김)
  { id: 'wma17_1m', label: '1분 이평선 (WMA17)', type: 'wma', period: 17, color: '#2196F3', lineWidth: 2, lineStyle: 0 },
  { id: 'sma20_3m', label: '3분 이평선 (SMA20)', type: 'sma', period: 60, color: '#FFFFFF', lineWidth: 2, lineStyle: 0 },
  { id: 'wma17_5m', label: '5분 이평선 (WMA17)', type: 'wma', period: 85, color: '#4FC3F7', lineWidth: 2, lineStyle: 0 },
  { id: 'wma4_1h', label: '1시간 이평선 (WMA4)', type: 'wma', period: 240, color: '#FFEB3B', lineWidth: 3, lineStyle: 2 },
]
